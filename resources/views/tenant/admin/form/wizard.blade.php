...
@section('page-style')
<link rel="stylesheet" href="{{asset('tenant-admin/plugins/jquery-steps/jquery.steps.css')}}"/>
@stop
@section('content')
...
@stop
@section('page-script')
<script src="{{asset('tenant-admin/plugins/jquery-validation/jquery.validate.js')}}"></script>
<script src="{{asset('tenant-admin/plugins/jquery-steps/jquery.steps.js')}}"></script>
<script src="{{asset('tenant-admin/js/pages/forms/form-wizard.js')}}"></script>
@stop