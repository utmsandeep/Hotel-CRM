    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form method="post" enctype="multipart/form-data"
                  action="{{ route('tenant.admin.hotelSetting.storenearby' , ['hotel_code'=>$hotel_code]) }}">
                @csrf
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                                        <div class="form-group">
                                                            <input type="number" value="{{ $item['distance'] }}"
                                                                   name="distance[]" min="0" class="form-control"
                                                                   placeholder="Distance in k.m." required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3">
                                                    <div class="form-group">
                                                        <input type="number" name="distance[]" min="0"
                                                               class="form-control" placeholder="Distance in k.m." required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3">
                                                    <div class="form-group">
