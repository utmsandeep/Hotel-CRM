                ...
                <div class="table-responsive">
                    <table class="table c_table inbox_table">
                        <tr>
                            ...
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar1.jpg')}}" alt="user" class="rounded" width="30"></td>
                        ...
                        <tr class="unread">
                            ...
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar2.jpg')}}" alt="user" class="rounded" width="30"></td>
                        ...
                        <tr>
                            ...
                            <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar3.jpg')}}" alt="user" class="rounded" width="30"></td>
                        ...
                        <tr class="unread">
                            ...
                            <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar4.jpg')}}" alt="user" class="rounded" width="30"></td>
                        ...
                        <tr>
                            ...
                            <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar5.jpg')}}" alt="user" class="rounded" width="30"></td>
                            <td class="u_name"><h5 class="font-15 mt-0 mb-0">Maryam Amiri</h6></td>
                            <td class="max_ellipsis">
                                <a class="link" href="{{route('app.single')}}">
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        ...
                        <tr>
                            ...
                            <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar6.jpg')}}" alt="user" class="rounded" width="30"></td>
                        ...
                        <tr>
                            ...
                            <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                            <td class="u_image"><img src="{{asset('tenant-admin/images/xs/avatar7.jpg')}}" alt="user" class="rounded" width="30"></td>
