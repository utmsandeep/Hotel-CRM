        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <ul class="list-unstyled team-info margin-0">                                               
                    <li><img src="{{asset('tenant-admin/images/xs/avatar7.jpg')}}" alt="Avatar"></li>
                    <li><img src="{{asset('tenant-admin/images/xs/avatar8.jpg')}}" alt="Avatar"></li>
                    <li><img src="{{asset('tenant-admin/images/xs/avatar9.jpg')}}" alt="Avatar"></li>
                    <li><img src="{{asset('tenant-admin/images/xs/avatar2.jpg')}}" alt="Avatar"></li>
                    <li><img src="{{asset('tenant-admin/images/xs/avatar3.jpg')}}" alt="Avatar"></li>
                </ul>
            </div>
        </div>
        <div class="card">
        ...
        <div class="card">
            ...
            <div class="body">
                <ul class="comment-reply list-unstyled">
                    ...
                    <li>
                        ...
                        <div class="text-box">
                            ...
                            <div class="mt-4">
                                ...
                                <img src="{{asset('tenant-admin/images/image-gallery/1.jpg')}}" alt="" class="img-fluid img-thumbnail w200">
                                <img src="{{asset('tenant-admin/images/image-gallery/2.jpg')}}" alt="" class="img-fluid img-thumbnail w200">
                                <img src="{{asset('tenant-admin/images/image-gallery/3.jpg')}}" alt="" class="img-fluid img-thumbnail w200"> 
                                <img src="{{asset('tenant-admin/images/image-gallery/4.jpg')}}" alt="" class="img-fluid img-thumbnail w200"> 
                            </div>
                        </div>
                    </li>
                    <hr>
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tenant-admin/images/sm/avatar3.jpg')}}" alt="Awesome Image"></div>
                        <div class="text-box">
                            <h5>Kareem Todd</h5>
                            <span class="comment-date">Wednesday, October 17, 2018 at 4:00PM.</span>
                            <a href="javascript:void(0);" class="replybutton"><i class="zmdi zmdi-mail-reply-all"></i> Reply</a>
                    ...
                    <hr>
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tenant-admin/images/sm/avatar4.jpg')}}" alt="Awesome Image"></div>
                        <div class="text-box">
                            <h5>Stillnot david</h5>
                            <span class="comment-date">Wednesday, October 17, 2018 at 4:00PM.</span>
                            <a href="javascript:void(0);" class="replybutton"><i class="zmdi zmdi-mail-reply-all"></i> Reply</a>
                    ...
                    <hr>
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tenant-admin/images/sm/avatar5.jpg')}}" alt="Awesome Image"></div>
                        <div class="text-box">
                            <h5>Kareem Todd</h5>
                            <span class="comment-date">Wednesday, October 17, 2018 at 4:00PM.</span>
                            <a href="javascript:void(0);" class="replybutton"><i class="zmdi zmdi-mail-reply-all"></i> Reply</a>
                    ...
                    <hr>
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tenant-admin/images/sm/avatar6.jpg')}}" alt="Awesome Image"></div>
                        <div class="text-box">
                            <h5>Stillnot david</h5>
                            <span class="comment-date">Wednesday, October 17, 2018 at 4:00PM.</span>
                            <a href="javascript:void(0);" class="replybutton"><i class="zmdi zmdi-mail-reply-all"></i> Reply</a>
...
<script src="{{asset('tenant-admin/plugins/summernote/dist/summernote.js')}}"></script>
<script src="{{asset('tenant-admin/js/pages/ticket-page.js')}}"></script>
@stop